...
pub fn encode_single_block(
    piece: &[u8; crate::PIECE_SIZE],
    id: &[u8],
    index: usize,
) -> [u8; crate::PIECE_SIZE] {
    // setup the cipher
...
pub fn encode_eight_blocks(
    pieces: &[[u8; crate::PIECE_SIZE]],
    id: &[u8],
    index: usize,
) -> Vec<[u8; crate::PIECE_SIZE]> {
    // setup the cipher
